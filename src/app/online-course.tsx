...
export function OnlineCourse() {
  return (
			<section id="sobre_ia" className="py-28 px-8">
				<div className="container mx-auto grid grid-cols-1 place-items-center lg:grid-cols-3">
					...
					<div className="col-span-2 lg:pl-24">
						...
						>
							...
							world of React, from its fundamentals to advanced techniques. Our
							expert instructors will guide you through every step.
						</Typography>
